...
urlpatterns = [
    ...
    path("<str:survey_id>/copy/", views.copy_survey, name="copy_survey"),
    ...
    path("<str:survey_id>/responses/<str:user_id>/accept/", views.accept_survey_response, name="accept_survey_response"),
]
